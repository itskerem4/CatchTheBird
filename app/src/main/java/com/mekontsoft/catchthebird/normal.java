...
public class normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoretxt = (TextView) findViewById(R.id.scoretxt2);
        ...
        new CountDownTimer(10000,1000){
            ...
            public void onFinish() {
                ...
                Toast.makeText(normal.this, "Time's Up!", Toast.LENGTH_SHORT).show();
                handler.removeCallbacks(runnable);
                for (ImageView image : imageArray){
                    image.setVisibility(View.INVISIBLE);
                }
                AlertDialog.Builder alert = new AlertDialog.Builder(normal.this);
                ...
                alert.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(normal.this, "Game Over", Toast.LENGTH_SHORT).show();
                        Intent Main = new Intent(normal.this, MainActivity.class);
                        startActivity(Main);
                    }
                });
                alert.show();
    ...
    public void mainmenubtn(View view) {
        Intent mainmenu = new Intent(normal.this, MainActivity.class);
