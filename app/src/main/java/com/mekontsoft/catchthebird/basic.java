...
public class basic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(10000,1000){
            ...
            public void onFinish() {
                ...
                Toast.makeText(basic.this, "Time's Up!", Toast.LENGTH_SHORT).show();
                handler.removeCallbacks(runnable);
                for (ImageView image : imageArray){
                    image.setVisibility(View.INVISIBLE);
                }
                AlertDialog.Builder alert = new AlertDialog.Builder(basic.this);
                ...
                alert.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(basic.this, "Game Over", Toast.LENGTH_SHORT).show();
                    }
                });
                alert.show();
            }
    ...
    public void mainmenubtn(View view) {
        Intent mainmenu = new Intent(basic.this, MainActivity.class);
